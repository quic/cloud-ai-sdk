...
def generate_inputs(onnx_model_path, batch_size,sequence=128):
    ...
    dims_map = {'Num_Class': 2, 'Sequence_len': 77, 'Batch_Size':batch_size, 'seq_len':sequence, 'total_seq_len':9, 'past_seq_len':1, 'beam_size':4, 'batch':batch_size,'sequence':sequence,'max_seq_len':sequence,'target_seq_len':2,'src_seq_len':sequence, 'height': 32, 'width':768, 'src_len':sequence,'sequence':sequence}
