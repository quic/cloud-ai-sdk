...
<mark>NOTE</mark> :Arm is a trademark of Arm Limited (or its subsidiaries) in the US and/or elsewhere. <br>
<mark>NOTE</mark> :Apps SDK is available only for x86 platforms.
