...
This page describes the various Model Preparator (MP) tool and it's features for AIC platform. For details on other toolchain, please refer to Overview page for further information.

This page will provide instructions on usage of MP tool, details on generating, compiling and executing the deep learning networks on the Qualcomm® Cloud AI 100 (AIC) Accelerator Card using AIC toolchain.

The QAic Model Preparator performs an automated way of generating Optimal AIC Friendly models for usage. It does apply various optimizations and cleaning techniques for generation of the model.
...
<img src="utils/stack.png" width="800" height="600">
...
* **PRE_PLUGIN**
    ...
    * For most of the NLP models, we have tokenization encodings of the inputs which we do in the host and pass the tokenized inputs to the model.
    ...
    <img src="utils/pre_plugin.png" width="500" height="500">
