...
python -m pip install fsspec==2024.2.0 wheel==0.42.0 sentence-transformers==2.6.1 onnx==1.15.0 onnxruntime==1.16.3 optimum==1.16.2 protobuf==3.20.2 urllib3==1.26.6
