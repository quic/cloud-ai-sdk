...
Refer to Profiler notebooks in the tutorials section for the complete system level profiling workflow for a CV/NLP model using the qaic-runner CLI. 
Profiling using Python APIs is also supported. Refer to ##FIXME
...
Refer to Profiler notebooks in the tutorials section for the complete system level profiling workflow for a CV/NLP model using the qaic-exec and qaic-runner CLI. 
